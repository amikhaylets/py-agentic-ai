...
- agent_functions.py - Core functionality for an AI-powered code generation agent:
...
- connection_test.py - Simple LLM connectivity test:
...
- simple_agent.py - Fragment of an agent execution loop:
